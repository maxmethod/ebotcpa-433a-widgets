/**
 * 433b-lawsuit embed bootstrap
 * Generated from 433b-lawsuit.html by scripts/build-embed.js — do not hand-edit.
 *
 * Drop into a GHL form step (Custom Code element) with:
 *   <div id="lawsuit-433b-widget" data-primary-color="{{custom_values.brand_primary_color}}"></div>
 *   <script src="https://cdn.jsdelivr.net/gh/maxmethod/ebotcpa-433a-widgets@vX.Y.Z/dist/embed-433b-lawsuit.js"></script>
 *
 * Or omit the <div> and the script appends the widget to <body>.
 */
(function () {
  if (window.__lawsuit433bEmbedLoaded) return;
  window.__lawsuit433bEmbedLoaded = true;

  // ---- styles ----
  const style = document.createElement('style');
  style.setAttribute('data-lawsuit-433b', 'styles');
  ...
  }#lawsuit-433b-widget#lawsuit-433b-widget * { box-sizing: border-box; }#lawsuit-433b-widget#lawsuit-433b-widget .ar-container { font-family: var(--ar-font); color: var(--ar-text); font-size: 15px; line-height: 1.5; }#lawsuit-433b-widget#lawsuit-433b-widget .ar-section { background: transparent; border: none; border-radius: 0; padding: 0; margin-bottom: 22px; }#lawsuit-433b-widget#lawsuit-433b-widget .ar-section + .ar-section { padding-top: 22px; border-top: 1px solid var(--ar-border); }#lawsuit-433b-widget#lawsuit-433b-widget .ar-section-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 4px; }#lawsuit-433b-widget#lawsuit-433b-widget .ar-section-title { font-size: 16px; font-weight: 700; margin: 0; }#lawsuit-433b-widget#lawsuit-433b-widget .ar-section-count { color: var(--ar-text-muted); font-size: 13px; }#lawsuit-433b-widget#lawsuit-433b-widget .ar-subtitle { font-size: 12px; color: var(--ar-text-muted); margin: 0 0 14px; }#lawsuit-433b-widget#lawsuit-433b-widget label { display: block; font-size: 13px; font-weight: 500; margin-bottom: 6px; color: var(--ar-text); }#lawsuit-433b-widget#lawsuit-433b-widget input[type="text"] {
  ...
  }#lawsuit-433b-widget#lawsuit-433b-widget input:focus { outline: none; border-color: var(--ar-accent); box-shadow: 0 0 0 3px color-mix(in srgb, var(--ar-accent) 22%, transparent); }#lawsuit-433b-widget#lawsuit-433b-widget .ar-amount-wrap { position: relative; }#lawsuit-433b-widget#lawsuit-433b-widget .ar-amount-wrap input { padding-left: 22px; }#lawsuit-433b-widget#lawsuit-433b-widget .ar-amount-wrap::before { content: "$"; position: absolute; left: 10px; top: 50%; transform: translateY(-50%); color: var(--ar-text-muted); font-size: 14px; pointer-events: none; }#lawsuit-433b-widget#lawsuit-433b-widget button {
  ...
  }#lawsuit-433b-widget#lawsuit-433b-widget button:hover { background: var(--ar-surface); }#lawsuit-433b-widget#lawsuit-433b-widget button.ar-primary { background: var(--ar-accent); border-color: var(--ar-accent); color: #fff; }#lawsuit-433b-widget#lawsuit-433b-widget button.ar-primary:hover { background: var(--ar-accent-hover); border-color: var(--ar-accent-hover); }#lawsuit-433b-widget#lawsuit-433b-widget button.ar-danger-text { background: transparent; border: none; color: var(--ar-danger); padding: 4px 8px; font-size: 13px; }#lawsuit-433b-widget#lawsuit-433b-widget button.ar-danger-text:hover { color: var(--ar-danger-hover); background: transparent; }#lawsuit-433b-widget#lawsuit-433b-widget .ar-add-box { background: #fff; border: 1px dashed var(--ar-border-strong); border-radius: var(--ar-radius); padding: 14px; }#lawsuit-433b-widget#lawsuit-433b-widget .ar-add-box h4 { margin: 0 0 10px; font-size: 14px; font-weight: 600; }#lawsuit-433b-widget#lawsuit-433b-widget .ar-field-group { display: grid; grid-template-columns: repeat(auto-fill, minmax(var(--ar-col-min, 240px), 1fr)); gap: 14px 16px; margin-bottom: 12px; }#lawsuit-433b-widget#lawsuit-433b-widget .ar-field-group > div { display: flex; flex-direction: column; justify-content: flex-end; }#lawsuit-433b-widget#lawsuit-433b-widget .ar-actions-right { display: flex; justify-content: flex-end; gap: 8px; margin-top: 4px; }#lawsuit-433b-widget#lawsuit-433b-widget .ar-items-list { margin-top: 14px; display: flex; flex-direction: column; gap: 8px; }#lawsuit-433b-widget#lawsuit-433b-widget .ar-item-card { background: #fff; border: 1px solid var(--ar-border); border-radius: var(--ar-radius); padding: 12px 14px; display: flex; justify-content: space-between; align-items: flex-start; gap: 12px; }#lawsuit-433b-widget#lawsuit-433b-widget .ar-item-main { flex: 1; min-width: 0; }#lawsuit-433b-widget#lawsuit-433b-widget .ar-item-name { font-weight: 500; font-size: 14px; }#lawsuit-433b-widget#lawsuit-433b-widget .ar-item-meta { font-size: 13px; color: var(--ar-text-muted); margin-top: 2px; }#lawsuit-433b-widget#lawsuit-433b-widget .ar-item-amount { font-weight: 600; font-size: 14px; white-space: nowrap; text-align: right; }#lawsuit-433b-widget#lawsuit-433b-widget .ar-empty { font-size: 13px; color: var(--ar-text-muted); font-style: italic; padding: 6px 0 0; }#lawsuit-433b-widget#lawsuit-433b-widget .ar-total { display: flex; justify-content: space-between; align-items: baseline; margin-top: 12px; padding-top: 10px; border-top: 2px solid var(--ar-border); font-size: 14px; font-weight: 700; }#lawsuit-433b-widget#lawsuit-433b-widget .ar-total .ar-total-val { color: var(--ar-accent); font-size: 16px; font-variant-numeric: tabular-nums; }#lawsuit-433b-widget#lawsuit-433b-widget .ar-warn { background: #fff3cd; border: 1px solid #ffd866; color: #665300; padding: 8px 12px; border-radius: var(--ar-radius); font-size: 13px; margin-bottom: 10px; display: none; }#lawsuit-433b-widget#lawsuit-433b-widget .ar-warn.visible { display: block; }`;
  document.head.appendChild(style);

  // ---- markup ----
  let container = document.getElementById('lawsuit-433b-widget') ||
                  document.querySelector('[data-lawsuit-433b-widget]');
  if (!container) {
    container = document.createElement('div');
    container.id = 'lawsuit-433b-widget';
...
(function () {
  ...
  // ============================================================
  var CONFIG = {
    "containerId": "lawsuit-433b-widget",
    "configGlobal": "LAWSUIT_433B_CONFIG",
    "colMin": "320px",
    "sections": [
      {
        "key": "433b_s3__lawsuit_detail",
        "id": "78CDwQe1HY2JfEEPvO76",
        "title": "Lawsuits",
        "noTotal": true,
        "subtitle": "Each lawsuit the business is a party to (IRS Form 433-B, line 9).",
        "addLabel": "Add a lawsuit",
        "addBtn": "Add lawsuit",
        "gateWarn": "Enter the plaintiff before adding.",
        "emptyNote": "No lawsuits added yet.",
        "columns": [
          {
            "id": "plaintiff",
            "label": "Plaintiff",
          ...
          {
            "id": "location",
            "label": "Location of filing (court)",
            "kind": "text",
            "ph": "Court / jurisdiction",
            "slabel": "Location"
          },
          {
            "id": "represented",
