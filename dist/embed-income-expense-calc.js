...
(function () {
  ...
  var writeTimer = null;
  function renderAll() { GROUPS.forEach(function (g) { render(g, computeGroup(g)); }); }
  function flushWrite()    { clearTimeout(writeTimer); GROUPS.forEach(function (g) { writeBack(g, computeGroup(g)); }); }
